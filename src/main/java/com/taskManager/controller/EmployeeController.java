...
public class EmployeeController {
    ...
    public String createInvoiceEmployee(@RequestParam("department_id") long id, @NotNull Model model){
        var department = departmentService.findById(id);
    ...
    public String registerNewEmployee(@RequestParam("department_id") String id,
